...
mxmlc "bin-debug/farm.swf" do |t|
  t.input = "src/farm.as"
  t.debug = true
end

desc "Compile and run the debug swf"
flashplayer :run => "bin-debug/farm.swf"
...
mxmlc "bin-debug/farm-test.swf" => :asunit4 do |t|
  t.input = "src/Test2Runner.as"
  t.source_path << 'test'
  t.debug = true
end

desc "Compile and run the test swf"
flashplayer :test => "bin-debug/farm-test.swf"

##############################
# SWC

compc "bin-debug/Test2.swc" do |t|
  t.input_class = "Test2"
  t.source_path << 'src'
end

desc "Compile the SWC file"
task :swc => 'bin-debug/Test2.swc'
...
asdoc 'doc' do |t|
  t.doc_sources << "src"
  t.exclude_sources << "src/Test2Runner.as"
end
